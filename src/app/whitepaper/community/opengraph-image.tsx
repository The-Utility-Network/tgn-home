...
export const alt = 'Community Factions - The Grande Narrative';
export const size = { width: 2400, height: 1260 };
export const contentType = 'image/png';

const THEME = '#8B5CF6'; // Purple for community
const ACCENT = '#f2a65a';

export default async function Image() {
    // Background - Use community background
    const bgData = readFileSync(join(process.cwd(), 'public', 'whitepaper', 'community_bg.jpeg'));
        ...
        (
            <div style={{
                ...
                <div style={{
                    ...
                    <div style={{ position: 'absolute', inset: 0, background: 'rgba(0,0,0,0.4)' }} />
                    <div style={{ position: 'absolute', inset: 0, border: '1px solid rgba(139,92,246,0.3)', borderRight: 'none', borderRadius: '40px 0 0 40px' }} />
                ...
                <div style={{
                    ...
                    <div style={{ position: 'absolute', inset: 0, background: 'rgba(139,92,246,0.2)' }} />
                    <div style={{ position: 'absolute', inset: 0, background: 'rgba(0,0,0,0.4)' }} />
                    <div style={{ position: 'absolute', inset: 0, border: '1px solid rgba(139,92,246,0.3)', borderLeft: 'none', borderRadius: '0 40px 40px 0' }} />
                    ...
                    <div style={{ position: 'relative', display: 'flex', flexDirection: 'column', alignItems: 'flex-start', zIndex: 10 }}>
                        ...
                        <div style={{ marginTop: 20, display: 'flex', flexDirection: 'column', gap: 12, borderLeft: `6px solid ${THEME}`, paddingLeft: 30 }}>
                            <span style={{ fontSize: 24, color: '#D1D5DB', letterSpacing: '0.15em', fontWeight: 500, textShadow: '0 2px 10px black' }}>THE PEOPLE'S GUILDS</span>
