...
function Section({ section, color }: { section: ChapterSection, color: string }) {
    ...
    return (
        ...
        >
            ...
            {/* Section Image */}
            {section.image && (
                <div className="mb-8 relative w-full rounded-2xl overflow-hidden border border-white/10 bg-black/20">
                    <img
                        src={section.image}
                        alt={section.heading}
...
function Chapter({ chapter, index }: { chapter: ChapterData, index: number }) {
    ...
    return (
        ...
        >
            {/* Chapter Artwork */}
            <ChapterArt chapterNumber={index + 1} chapterId={chapter.id} color={chapter.color} />
...
export default function AdminWhitepaperPage() {
    ...
    useEffect(() => {
        const newParticles = [...Array(30)].map((_, i) => ({
            id: i,
            color: chapters[i % chapters.length].color,
            ...
            <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
                ...
                <div className="relative z-10 text-center px-6 max-w-5xl mx-auto">
                    ...
                    >
                        ...
                        <span
                            style={{
                                background: `linear-gradient(135deg, ${chapters[0].color}, ${chapters[Math.floor(chapters.length / 2)].color}, ${chapters[chapters.length - 1].color})`,
                                WebkitBackgroundClip: 'text',
                                WebkitTextFillColor: 'transparent'
                            }}
                        >
                    ...
                    >
                        The Pillars of Order, Governance, and Security in The Utility Company
                    </motion.p>
                    ...
                    >
                        ...
                        <div className="text-sm text-gray-500 font-mono">
                            {chapters.length} Chapters • Est. 1+ hours
                        </div>
                    </motion.div>
                        ...
                        <article className="flex-1 max-w-3xl">
                            ...
                            >
                                <blockquote
                                    ...
                                    style={{ fontFamily: 'Georgia, serif' }}
                                >
                                    "Order is the foundation upon which true liberty is built."
                                </blockquote>
                            ...
                            >
                                <div
                                    ...
                                    style={{
                                        background: `linear-gradient(135deg, ${chapters[0].color}20, ${chapters[Math.floor(chapters.length / 2)].color}20, ${chapters[chapters.length - 1].color}20)`
                                    }}
                                >
                                ...
                                <p className="text-gray-400 max-w-lg mx-auto leading-relaxed mb-8">
                                    Establishing the framework for a secure, prosperous, and self-reliable future.
                                </p>
                                <a
                                    href="/"
