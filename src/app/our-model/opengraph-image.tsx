        ...
        (
            <div style={{
                ...
                <div style={{
                    ...
                    <div style={{ position: 'absolute', inset: 0, border: '1px solid rgba(255,255,255,0.15)', borderRight: 'none', borderRadius: '40px 0 0 40px' }} />
                ...
                <div style={{
                    ...
                    <div style={{ position: 'absolute', inset: 0, background: 'rgba(0,0,0,0.5)' }} />
                    <div style={{ position: 'absolute', inset: 0, background: 'rgba(255,255,255,0.05)' }} />
                    <div style={{ position: 'absolute', inset: 0, border: '1px solid rgba(255,255,255,0.15)', borderLeft: 'none', borderRadius: '0 40px 40px 0' }} />
                    ...
                    <div style={{ position: 'relative', display: 'flex', flexDirection: 'column', alignItems: 'flex-start', zIndex: 10 }}>
                        ...
                        <div style={{ marginTop: 20, display: 'flex', flexDirection: 'column', gap: 12, borderLeft: `6px solid ${THEME}`, paddingLeft: 30 }}>
                            ...
                            <span style={{ fontSize: 24, color: THEME, letterSpacing: '0.15em', fontWeight: 700, textShadow: '0 2px 10px black' }}>thegrandenarrative.com/our-model</span>
                        </div>
                    </div>
                </div>
                ...
                <div style={{ position: 'absolute', left: 40, top: 40, width: 2320, height: 40, overflow: 'hidden', borderRadius: '24px 24px 0 0', display: 'flex', zIndex: 5, boxShadow: 'inset 0 0 10px rgba(255,255,255,0.2)' }}>
                    <img src={bgBase64} width={2400} height={1260} style={{ position: 'absolute', left: -40, top: -40, objectFit: 'cover', filter: 'blur(20px) brightness(0.5)', transform: 'scale(1.1)' }} />
                    <div style={{ position: 'absolute', inset: 0, background: 'rgba(0,0,0,0.5)' }} />
                ...
                <div style={{ position: 'absolute', left: 40, top: 1180, width: 2320, height: 40, overflow: 'hidden', borderRadius: '0 0 24px 24px', display: 'flex', zIndex: 5, boxShadow: 'inset 0 0 10px rgba(255,255,255,0.2)' }}>
                    <img src={bgBase64} width={2400} height={1260} style={{ position: 'absolute', left: -40, top: -1180, objectFit: 'cover', filter: 'blur(20px) brightness(0.5)', transform: 'scale(1.1)' }} />
                    <div style={{ position: 'absolute', inset: 0, background: 'rgba(0,0,0,0.5)' }} />
                ...
                <div style={{ position: 'absolute', left: 40, top: 80, width: 40, height: 1100, overflow: 'hidden', display: 'flex', zIndex: 5, boxShadow: 'inset 0 0 10px rgba(255,255,255,0.2)' }}>
                    <img src={bgBase64} width={2400} height={1260} style={{ position: 'absolute', left: -40, top: -80, objectFit: 'cover', filter: 'blur(20px) brightness(0.5)', transform: 'scale(1.1)' }} />
                    <div style={{ position: 'absolute', inset: 0, background: 'rgba(0,0,0,0.5)' }} />
                ...
                <div style={{ position: 'absolute', left: 2320, top: 80, width: 40, height: 1100, overflow: 'hidden', display: 'flex', zIndex: 5, boxShadow: 'inset 0 0 10px rgba(255,255,255,0.2)' }}>
                    <img src={bgBase64} width={2400} height={1260} style={{ position: 'absolute', left: -2320, top: -80, objectFit: 'cover', filter: 'blur(20px) brightness(0.5)', transform: 'scale(1.1)' }} />
                    <div style={{ position: 'absolute', inset: 0, background: 'rgba(0,0,0,0.5)' }} />
                    <div style={{ position: 'absolute', inset: 0, border: '1px solid rgba(255,255,255,0.15)', borderTop: 'none', borderBottom: 'none' }} />
                </div>
